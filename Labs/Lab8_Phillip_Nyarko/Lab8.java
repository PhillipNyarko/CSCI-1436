...
public class Lab8 { // main class
	public static void main(String args[]) { // main method
		...
		System.out.print("Enter the number of rows in the conversion table: "); // prompt the user for input
		 ...
		 * not printing even values*/
                while (i < numberOfRows*2){ // only execute loop while the loop variable is less then double the number of rows
			...
			i += 2; // increment the loop control variable by 2
		}
